...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=x86_64 --target-os=mingw32-w64 --cross-prefix=x86_64-w64-mingw32- --pkg-config=pkg-config --enable-static --enable-shared --enable-gpl --enable-nonfree --prefix=/home/jingdong/work/fmpsdk --enable-libx264 --extra-cflags=-I/home/jingdong/work/fmpsdk/include --extra-ldflags=-L/home/jingdong/work/fmpsdk/lib
...
OBJCFLAGS=  
ASFLAGS=  -I/home/jingdong/work/fmpsdk/include -fPIC -g
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DEPWINDRES=x86_64-w64-mingw32-gcc
DOXYGEN=doxygen
LDFLAGS= -L/home/jingdong/work/fmpsdk/lib  -Wl,--nxcompat,--dynamicbase -Wl,--high-entropy-va -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
