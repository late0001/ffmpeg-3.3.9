...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=x86 --target-os=mingw32 --cross-prefix=i686-w64-mingw32- --pkg-config=pkg-config --enable-static --enable-shared --enable-gpl --enable-nonfree --prefix=/home/jingdong/work/fmpsdk --enable-libx264 --extra-cflags=-I/home/jingdong/work/fmpsdk/include --extra-ldflags='-L/home/jingdong/work/fmpsdk/lib -static-libgcc '
prefix=/home/jingdong/work/fmpsdk
...
CC_IDENT=gcc 7.3-win32 (GCC) 20180312
ARCH=x86
INTRINSICS=none
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
CFLAGS=  -I/home/jingdong/work/fmpsdk/include -std=c11 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/home/jingdong/work/fmpsdk/include -g
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -L/home/jingdong/work/fmpsdk/lib -static-libgcc  -Wl,--large-address-aware -Wl,--nxcompat,--dynamicbase -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lws2_32 -lavicap32 -lgdi32 -lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi -luser32   -lsecur32 -lx264 -lm -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
